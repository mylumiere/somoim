...
from somoim.views import MoimListView, MoimView, ScheduleListView, ScheduleView, ArticleListView, ArticleView
...
urlpatterns = [
    ...
    path('api/moims/<int:id>/schedules', ScheduleListView.as_view(), name='moim_detail'),
    path('api/moims/<int:id>/schedules/<int:s_id>', ScheduleView.as_view(), name='moim_detail'),
